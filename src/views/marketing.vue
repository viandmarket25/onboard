<template>
 <div style="background:#fbfbfb; " class="bg-white">
  ...
  <header class="flex flex-wrap sm:justify-start sm:flex-nowrap z-50 w-full bg-white border-b border-gray-200 text-sm py-4 dark:bg-gray-800 dark:border-gray-700">
    <nav class="max-w-[85rem] w-full mx-auto px-4 sm:flex sm:items-center sm:justify-between sm:px-6 lg:px-8" aria-label="Global">
      <div class="flex items-center justify-between">
        <a class="flex-none text-xl font-semibold dark:text-white" href="/" aria-label="Brand">SalesBoyi</a>
        <div class="sm:hidden">
...
<div class="relative overflow-hidden before:absolute before:top-0 before:left-1/2 before:bg-[url('../svg/component/polygon.svg')] before:bg-no-repeat before:bg-top before:bg-cover before:w-full before:h-full before:-z-[1] before:transform before:-translate-x-1/2 dark:before:bg-[url('../svg/component/polygon-dark.svg')]">
  <div class="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-10">
    ...
    <div class="mt-5 max-w-2xl text-center mx-auto">
      <h3 class="block font-bold text-gray-800 text-4xl md:text-5xl lg:text-6xl dark:text-gray-200">
        Innovative AI-powered e-commerce platform 
    ...
    <div class="mt-5 max-w-3xl text-center mx-auto">
      <p class="text-lg text-gray-600 dark:text-gray-400"> Experience seamless payments, effortless product listing, efficient order management, and secure customer communication.</p>
    </div>
      ...
      <div class="space-y-6 sm:space-y-8">
        ...
        <div class="space-y-2 md:space-y-4">
          <h2 class="font-bold text-3xl lg:text-4xl text-gray-800 dark:text-gray-200">
            Why should I sell using SalesBoyi
          </h2>
...
<div class="max-w-[85rem] mx-auto py-10 px-4 sm:px-6 lg:px-8">
  ...
  <div class="grid lg:grid-cols-7 lg:gap-x-8 xl:gap-x-12 lg:items-center">
    <div class="lg:col-span-3">
      <h1 class="block text-3xl font-bold text-gray-800 sm:text-4xl md:text-5xl lg:text-6xl dark:text-white"> Storefronts Inspired by Leading Brands</h1>
      <p class="mt-3 text-lg text-gray-800 dark:text-gray-400"> Customizable Storefronts Inspired by Leading Brands.</p>
...
<!-- End Hero -->
      ...
      <div class="grid gap-12">
        <div>
          ...
          <p class="mt-3 text-gray-800 dark:text-gray-400">
            At SalesBoyi, our vision is to empower businesses of all sizes to thrive in the digital marketplace by providing them with innovative tools and unparalleled support. We envision a future where every merchant can effortlessly navigate the complexities of e-commerce, reach global customers, and achieve unparalleled success.
          </p>
        </div>
        ...
        <div class="space-y-6 lg:space-y-10">
            ...
            <div class="ml-5 sm:ml-8">
              ...
              <p class="mt-1 text-gray-600 dark:text-gray-400">
                We understand that collecting payments from customers can be a challenge for many businesses. That's why we provide a hassle-free payment collection system, regardless of whether you are a new seller or an established business. We take care of collecting charges from customers on your behalf, ensuring a smooth transaction process for both sellers and buyers.
              </p>
            </div>
          </div>
          <!-- End Icon Block -->
          ...
          <div class="flex">
            ...
            <div class="ml-5 sm:ml-8">
              ...
              <p class="mt-1 text-gray-600 dark:text-gray-400">
                We aim to simplify the complexities of order management for businesses. Our platform provides intuitive tools that streamline the entire process, from order tracking to fulfillment. By removing the hassle and enabling quick, cost-effective, and efficient order management, we envision businesses effortlessly handling their operations, improving customer satisfaction, and achieving unparalleled efficiency.
              </p>
            </div>
          </div>
          <!-- End Icon Block -->
          ...
          <div class="flex">
            ...
            <div class="ml-5 sm:ml-8">
              ...
              <p class="mt-1 text-gray-600 dark:text-gray-400">
                Our ultimate vision is to empower businesses to grow and succeed in the fiercely competitive e-commerce landscape. We combine the power of innovative AI solutions with comprehensive support and guidance to enable merchants to make data-driven decisions, optimize their strategies, and unlock new opportunities. We envision businesses leveraging our platform to expand their reach, drive sales, and achieve long-term success.
              </p>
            </div>
          </div>
          <!-- End Icon Block -->
  ...
  <div class="max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 mx-auto">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 items-center gap-5 text-center">
      <div>
        <a class="flex-none text-xl font-semibold text-black dark:text-white" href="#" aria-label="Brand">SalesBoyi</a>
      </div>
      <!-- End Col -->
