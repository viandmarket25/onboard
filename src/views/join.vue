...
<!-- End Icon -->
        ...
        <div class="pt-5 sm:pt-0 sm:pl-5">
          <div class="text-lg font-semibold text-gray-800 dark:text-gray-200">People in Waitlist</div>
          <div class="text-sm text-gray-500">3,100 </div>
        </div>
      </div>
      <!-- End Avatar Group -->
      ...
      <form>
        ...
        <div class="mx-auto max-w-2xl sm:flex sm:space-x-3 p-3 bg-white border rounded-lg shadow-lg shadow-gray-100 dark:bg-slate-900 dark:border-gray-700 dark:shadow-gray-900/[.2]">
          <div class="pb-2 sm:pb-0 sm:flex-[1_0_0%]">
            ...
            <input type="text" id="hs-hero-name-1" class="py-3 px-4 block w-full border-transparent rounded-md text-sm focus:border-blue-500 focus:ring-blue-500 sm:p-4 dark:bg-slate-900 dark:border-transparent dark:text-gray-400" placeholder="Full name">
          </div>
